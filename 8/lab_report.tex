...
\noindent Note that repeating our signal in the time domain has inserted zeros into our frequency response similar to how upsampling in the time-domain leads to replication in the frequency domain. The frequency of the first harmonic (20 Hz) also corresponds to the frequency of rotation.
