...
\noindent We then use MATLAB to differentiate this expression over time. The derivative of the radial distance is the radial velocity, which we can use in Equation \ref{eq::dopp_shift} to compute the corresponding doppler shift.
