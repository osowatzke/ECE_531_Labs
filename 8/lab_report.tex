...
%  We can also consider other designs such as pulsed doppler radar. However, these radars may not be applicable for all uses cases (especially for handling of close targets). 
