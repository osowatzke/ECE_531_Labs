...
For a sinusoid, we further note that the constellation points are evenly spaced around the unit circle. To better visualize the effects of I/Q imbalance, we continue our experiments with the 39.8 kHz sample rate. Figure \ref{fig::iq_imbalance_1_mag_0_phase_39p8k_samp_rate_const} shows the effects with 1 dB of I/Q amplitude imbalance.
...
\begin{equation}
	x_{rx}(t) = \cos\phi\cos(2{\pi}f_0t) + j\sqrt{1+\sin^2\phi}\sin(2{\pi}f_0t + \text{atan}(\sin\phi))
\end{equation}
