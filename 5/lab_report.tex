...
Type I Nyquist filters have an infinite impulse response and small timing errors input to a type I Nyquist filter result in large ISI because their impulse response decays with 1/t, which does not converge.
