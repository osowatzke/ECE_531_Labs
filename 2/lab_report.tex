...
\begin{figure}[H]
	\centerline{\fbox{\includegraphics[width=0.9\textwidth]{iio_info_putty.png}}}
	\caption{Result of ``iio\_info -s" Command when Executed in Putty}
	\label{fig::iio_info_putty}
\end{figure}

\begin{figure}[H]
	\centerline{\fbox{\includegraphics[width=0.9\textwidth]{iio_info_cmd.png}}}
	\caption{Result of ``iio\_info -s" Command when Executed in Command Prompt}
	\label{fig::iio_info_cmd}
\end{figure}

\begin{figure}[H]
	\centerline{\fbox{\includegraphics[width=0.9\textwidth]{iio_info_vm.png}}}
