...
\begin{figure}[H]
	\centerline{\fbox{\includegraphics[width=0.8\textwidth]{pluto_iio_device_sink.png}}}
	\caption{Hierarchy Block which Functions as Pluto Sink}
	\label{fig::pluto_iio_device_sink}
\end{figure}

Both the source and sink hierarchy blocks use multiple IIO Channel Attribute blocks, described by Figure \ref{fig::iio_input_channel_attribute}, to set block parameters. Each of these blocks get the same arguments as the \texttt{iio\_attr} command.
