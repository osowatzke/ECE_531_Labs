...
In this experiment, we use measure the SNR of the Pluto loopback signal. We collect data with a 50\% duty cycle in MATLAB. Then, we use the "zero" regions of the received signal to measure the noise power and the signal portions of the pulse to measure the power of the signal-plus-noise. With our measurements, we estimate the signal to noise ratio as follows.
